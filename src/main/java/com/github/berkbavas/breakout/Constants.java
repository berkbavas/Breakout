...
public final class Constants {
    ...
    public final static class World {
        ...
        public static final double BORDER_VERTICAL = 0;
        public static final double BORDER_HORIZONTAL = 0;
        public static final Color BACKGROUND_COLOR = Color.rgb(0, 0, 0);
        public static final Color BORDER_COLOR = Color.rgb(255, 255, 255);
